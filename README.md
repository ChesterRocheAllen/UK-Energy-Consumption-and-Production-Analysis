...
Analysing the visual data on energy consumption in the UK reveals several key trends in the evolution of energy demand across different sectors: Industry, Service, Domestic, and Transportation. These trends are influenced by a variety of factors, including technological advancements, economic shifts, changes in consumer behaviour, and external events like the COVID-19 pandemic. Below is a more detailed examination of these trends and their underlying causes.

### Industrial Sector: Decline in Energy Consumption
The industrial sector shows a clear reduction in energy consumption starting from the late 1970s. This decline is primarily attributed to deindustrialization, a process in which manufacturing and heavy industry declined in importance relative to the service sector. The UK, like many other developed nations, experienced a shift away from labour-intensive industries such as coal mining, steel production, and textiles toward more service-based economic activities.
...
By the 2010s, the energy consumption from the industrial sector had declined to levels comparable to that of the service sector, a dramatic shift from earlier decades when the industry was the largest energy consumer. This trend highlights the ongoing transformation of the UK economy into a more service-oriented one, where energy consumption is driven more by office buildings, commercial enterprises, and other non-manufacturing activities.
...
This panel shows the electricity consumption by different sectors from around 2000 to 2020. The graph uses stacked areas, where each colour represents a different sector.

- **Transport**: The electricity consumption by the transportation sector, is relatively small compared to other sectors.
...
- **Domestic**: Household electricity consumption, appears to be the largest contributor and seems to decline in recent years.
...
- **Coal**: Coal-based electricity generation, which sharply declined, especially after the mid-2010s, reflects the UK's efforts to reduce reliance on fossil fuels.
- **Bioenergy**: Electricity from bioenergy, which has steadily increased over time, particularly replacing coal in many cases.
- **Gas**: Gas-based production, remains relatively stable but does see a slight decrease.
...
The two highest valued goods are oil products showing how reliant the UK is on oil imports.
...
## Clean Energy 
In this analysis, linear regression was used through Python to predict future energy production trends in the UK from 2023 onwards, with the predicted values represented by the dashed lines in the graphs. The line graph displays the energy production (in GWh) for various energy sources, including wind, wave, solar, nuclear, hydropower, and polluting fuels (coal, gas, oil).
...
- **Wind, Wave, and Solar**: The share of renewable energy from wind, wave, and solar sources has grown significantly, and this trend is expected to continue. By 2030, these renewable sources will become the dominant contributors to the UK’s energy mix, displacing fossil fuels.
...
- **Polluting Fuels**: The proportion of polluting fuels has steadily decreased, and by 2030, fossil fuels are expected to make up less than half of the energy mix. This decline reflects the UK's ongoing shift away from carbon-intensive energy sources in favour of cleaner, more sustainable options.
### Key Insights
By 2030, wind, wave, and solar energy are expected to dominate the UK's energy mix with 38.57%, with renewable sources making up a majority of energy production. Nuclear energy will maintain a stable role, but its contribution to growth will be modest in comparison to the rapid expansion of renewables. The use of polluting fuels such as coal, oil, and gas is expected to decrease significantly, making up a minimal portion of the energy mix, reflecting the UK's commitment to reducing carbon emissions. Although hydropower will continue to be part of the clean energy mix, its growth potential is limited compared to more scalable sources like wind and solar. Overall, the graph illustrates the UK's ongoing transition to a decarbonized energy system, where wind and solar will lead the way, and fossil fuels will play a very small role.
## Transportation Fuel Consumption
This visualization provides insights into the UK's transportation fuel consumption and new vehicle registrations by fuel type from 1970 to 2023. It is divided into two panels: one focusing on fuel consumption in kilotons of oil equivalent (KTOE) by various transportation modes, and the other depicting the percentage of new vehicle registrations by fuel type. 
![Page6](Image/Page6.png)
### Transportation Fuel Consumption by Transportation in KTOE Time Series Graph and Pie Chart
This graph shows the annual fuel consumption by different transportation sectors over time (1970–2023), expressed in Kilotons of Oil Equivalent (KTOE)
- **Air Petroleum** : This line represents petroleum consumption in air travel. The graph shows a steady increase from around 1970 until around 2005, after which it plateaus. While air travel continues to consume significant amounts of petroleum, the growth has slowed in recent years, possibly due to improvements in fuel efficiency and changes in air travel patterns due to COVID-19.
-**Rail Electricity**: The rail sector shows relatively low electricity consumption in the early years, but there is a gradual increase from the early 2000s onwards. This growth may be due to more rail networks switching to electricity as a cleaner and more efficient power source.
- **Rail Petroleum**: The consumption of petroleum for rail travel has been quite stable and remains relatively low. This suggests that rail transport is less dependent on petroleum than other sectors.
-**Road Bioenergy & Waste**: The consumption of bioenergy and waste in road transport is minimal in the early years but shows an increasing trend post-2010. This could be attributed to the gradual adoption of alternative fuels in road transportation, such as biofuels.
- **Road Electricity**: The electricity consumption for road transport remains low but is expected to rise significantly, reflecting the growing shift to electric vehicles (EVs).
- **Road Petroleum**: This is the largest and most dominant category. Petroleum consumption for road transport increases steadily up to around 2015 and then starts to decrease as the share of electric vehicles (EVs) and biofuels increases. The decline in the petroleum consumption trend from 2020 onwards reflects the transition to electric vehicles the shift away from fossil fuels and the effects of COVID.
### New Vehicle Registrations by Fuel 
This stacked area chart shows the percentage of new vehicle registrations by fuel type over time (from 2014 to 2023). It highlights the increasing adoption of electric vehicles (EVs) and the decline of traditional fossil fuel-powered vehicles.
- **Petrol** : Petrol-powered vehicles made up a significant proportion of new registrations until around 2017. After 2017, the share of petrol vehicles steadily declines as consumers shift toward more fuel-efficient and environmentally-friendly options.
- **Diesel** : Diesel vehicle registrations peaked around 2016 but have sharply decreased after that, likely due to increasing awareness of diesel's negative environmental impact and the tightening of regulations on emissions.
-**Hybrid Electric Petrol**, Hybrid electric vehicles (those using both petrol and electric power) show a steady increase from around 2015, reflecting growing interest in hybrid vehicles as a transitional technology before full electrification.
- **Plug-in Hybrid Electric** : The growth of plug-in hybrid vehicles (with the ability to charge from an electric outlet and also use petrol) shows significant increases post-2017, though their share is smaller than hybrids.
- **Battery Electric Vehicles** : Battery electric vehicles (BEVs) are experiencing rapid growth, especially after 2020. The share of BEVs has risen sharply, reflecting the UK’s push toward zero-emission vehicles.
- **Fuel Cell Electric** : Fuel cell electric vehicles, which use hydrogen as fuel, contribute a small but growing share of new vehicle registrations, though their adoption is still relatively low compared to BEVs.
### Key Insights
The decline in petroleum use for road transport is evident, likely driven by the growing adoption of electric vehicles (EVs). This shift marks a significant move towards cleaner alternatives and reduced reliance on fossil fuels. Battery electric vehicles (BEVs) are rapidly increasing in number, representing a larger portion of new vehicle registrations, which reflects the UK’s ongoing transition to cleaner transportation options. Concurrently, diesel use is decreasing as diesel vehicle registrations fall, likely influenced by environmental policies, consumer preferences, and stricter emissions standards. The popularity of hybrid electric vehicles (HEVs) and plug-in hybrid electric vehicles (PHEVs) is also rising, serving as an important step toward the full adoption of fully electric vehicles. Air transport, while still heavily reliant on petroleum, has seen slower growth in fuel consumption, reflecting improvements in aviation efficiency and the potential for more sustainable fuels in the future. The COVID-19 pandemic also had a notable impact, with reduced air travel and transportation consumption, but the long-term trend continues to point toward cleaner, more sustainable transportation solutions.
## Conclusion 
The analysis of UK energy consumption and production reveals a significant shift towards sustainability and decarbonization across key sectors—Transportation, Industry, Domestic, and Service. A clear trend is emerging, with a decreasing reliance on fossil fuels, particularly coal, oil, and gas. The transportation sector, once heavily dependent on petroleum, is transitioning to electric vehicles (EVs) and alternative fuels, driven by government policies, consumer preferences, and technological advancements. In the domestic sector, the reliance on gas for heating and cooking highlights the need for more energy-efficient solutions and a shift to electric heating systems. Meanwhile, the service sector's stable energy consumption reflects the impact of digitalization and efficiency measures.

The rise of renewable energy, particularly wind, solar, and bioenergy, signals a promising transformation in the UK's energy mix, aligning with the government's climate goals and commitment to energy security. Renewables are expected to dominate future energy production, supporting the UK's ambition for net-zero emissions. However, the growing dependence on energy imports underscores the need for strategic management of external sources while continuing investments in cleaner domestic energy solutions.

In summary, the UK's energy landscape is undergoing a profound transformation, marked by a shift to renewable energy, improved efficiency, and technological innovation. Understanding these trends will be essential for stakeholders to develop informed policies, drive innovation, and ensure a successful transition to a decarbonized economy, securing a greener, more sustainable future for generations to come.

## Note 
Please feel free to explore the data model with the attached Power BI Desktop file.
## Sources 
UK vehicle-licensing statistics   hhttps://www.gov.uk/government/statistics/vehicle-licensing-statistics-2023

Digest of UK Energy Statistics    https://www.gov.uk/government/statistics/electricity-chapter-5-digest-of-united-kingdom-energy-statistics-dukes

Energy consumption in the UK 2024 https://www.gov.uk/government/statistics/energy-consumption-in-the-uk-2024

Export Data                       https://www.cepii.fr/DATA_DOWNLOAD/baci/data/BACI_HS92_V202501.zip
